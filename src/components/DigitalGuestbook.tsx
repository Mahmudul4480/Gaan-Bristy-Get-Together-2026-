...
export default function DigitalGuestbook() {
  ...
  return (
    <section id="guestbook" className="py-16 bg-[#0F0C1A] text-[#F6EFE0] relative overflow-hidden border-t border-[#D4AF37]/30">
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Section Title */}
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#7A1F3D]/60 border border-[#D4AF37]/40 text-[#F0D78C] text-xs font-semibold">
            <MessageSquarePlus className="w-3.5 h-3.5 text-[#D4AF37]" />
            <span>Digital Guestbook • গেস্টবুক ও শুভেচ্ছা বার্তা</span>
          </div>
          <h2 className="text-3xl sm:text-5xl font-extrabold font-english-heading text-[#F0D78C]">
            Digital Guestbook
          </h2>
          <p className="text-[#B3A6C9] text-sm sm:text-base font-body">
            ২০২৬ এর গ্র্যান্ড মিলনমেলা উপলক্ষে আপনার মূল্যবান শুভেচ্ছা ও বার্তা লিখে জানান।
          </p>
          <div className="w-24 h-1 bg-gradient-to-r from-[#D4AF37] to-[#7A1F3D] mx-auto my-3 rounded-full"></div>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          
          {/* LEFT: Write Message Form */}
          <div className="lg:col-span-5 bg-[#1C1730] border-2 border-[#D4AF37] rounded-3xl p-6 sm:p-8 shadow-2xl relative">
            <div className="flex items-center gap-2 mb-6 pb-3 border-b border-[#D4AF37]/30">
              <Sparkles className="w-5 h-5 text-[#D4AF37]" />
              <h3 className="text-lg font-bold text-[#F0D78C] font-serif">আপনার শুভেচ্ছা লিখুন</h3>
            </div>

            {submittedSuccess && (
              <div className="mb-5 p-3.5 bg-[#7A1F3D]/60 border border-[#D4AF37]/50 text-[#F0D78C] rounded-2xl text-xs font-semibold flex items-center gap-2">
                <CheckCircle2 className="w-5 h-5 text-[#D4AF37] shrink-0" />
                <span>ধন্যবাদ! আপনার বার্তাটি ডিজিটাল গেস্টবুকে যুক্ত হয়েছে।</span>
              </div>
            )}
            ...
            <form onSubmit={handleSubmitMessage} className="space-y-4 font-body">
              <div>
                <label className="block text-xs font-semibold text-[#F6EFE0] mb-1">
                  আপনার নাম (Full Name) <span className="text-[#D4AF37]">*</span>
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0F0C1A] border border-[#D4AF37]/30 focus:border-[#D4AF37] rounded-xl pl-10 pr-4 py-2.5 text-sm text-[#F6EFE0] outline-none transition"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0F0C1A] border border-[#D4AF37]/30 focus:border-[#D4AF37] rounded-xl px-3.5 py-2.5 text-sm text-[#F6EFE0] font-mono outline-none transition"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="যেমন: গান খুঁজে পায় আলো"
                      className="w-full bg-[#0F0C1A] border border-[#D4AF37]/30 focus:border-[#D4AF37] rounded-xl pl-8 pr-3 py-2.5 text-sm text-[#F6EFE0] outline-none transition"
                    />
                  </div>
                </div>
              </div>
              ...
              <div>
                <label className="block text-xs font-semibold text-[#F6EFE0] mb-1">
                  আপনার শুভেচ্ছা ও অনুভূতি <span className="text-[#D4AF37]">*</span>
                </label>
                <textarea
                  required
                  rows={4}
                  ...
                  placeholder="গান বৃষ্টি পরিবার ও গুলশান ক্লাবের এই গেট-টুগেদার নিয়ে আপনার অনুভূতি লিখুন..."
                  className="w-full bg-[#0F0C1A] border border-[#D4AF37]/30 focus:border-[#D4AF37] rounded-xl p-3.5 text-sm text-[#F6EFE0] outline-none transition resize-none"
                />
              </div>

              <button
                type="submit"
                className="w-full py-3.5 gold-gradient-btn text-[#0F0C1A] font-extrabold rounded-full text-sm transition shadow-xl flex items-center justify-center gap-2 cursor-pointer"
              >
                <Send className="w-4 h-4" />
                <span>গেস্টবুকে বার্তা পোস্ট করুন</span>
              </button>
            </form>
          </div>
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            {/* Search & Stats Bar */}
            <div className="bg-[#1C1730] border border-[#D4AF37]/30 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-3">
              <div className="flex items-center gap-2 text-xs text-[#F6EFE0] font-semibold w-full sm:w-auto">
                <MessageCircle className="w-4 h-4 text-[#D4AF37]" />
                <span>মোট শুভেচ্ছা বার্তা: <strong className="text-[#F0D78C] font-mono text-sm">{entries.length}</strong></span>
              </div>
              ...
              <div className="relative w-full sm:w-64">
                ...
                <input
                  ...
                  className="w-full bg-[#0F0C1A] border border-[#D4AF37]/30 focus:border-[#D4AF37] rounded-full pl-8 pr-3 py-1.5 text-xs text-[#F6EFE0] outline-none transition"
                />
              </div>
            </div>
            ...
            <div className="max-h-[520px] overflow-y-auto pr-1 space-y-4 custom-scrollbar">
              {filteredEntries.length === 0 ? (
                <div className="bg-[#1C1730]/50 border border-[#D4AF37]/30 rounded-2xl p-8 text-center text-[#B3A6C9] space-y-2">
                  <p className="text-sm font-semibold">কোনো বার্তা খুঁজে পাওয়া যায়নি!</p>
                ...
                filteredEntries.map((entry) => {
                  ...
                  return (
                    <div
                      key={entry.id}
                      className="bg-[#1C1730] border border-[#D4AF37]/30 hover:border-[#D4AF37] rounded-2xl p-5 shadow-lg transition duration-200 relative group"
                    >
                      <div className="flex items-start justify-between gap-3 mb-3">
                        <div className="flex items-center gap-3">
                          {/* Avatar Circle */}
                          <div className={`w-10 h-10 rounded-full bg-gradient-to-tr ${entry.avatarColor || 'from-[#D4AF37] to-[#7A1F3D]'} flex items-center justify-center font-bold text-[#F6EFE0] text-base shadow-md shrink-0 border border-[#D4AF37]/40`}>
                            {initialLetter}
                          </div>

                          <div>
                            <div className="flex items-center gap-2 flex-wrap">
                              <h4 className="text-sm font-bold text-[#F6EFE0] font-serif">{entry.name}</h4>
                              {entry.badge && (
                                <span className="bg-[#7A1F3D] text-[#F0D78C] border border-[#D4AF37]/40 text-[10px] font-bold px-2 py-0.5 rounded-full flex items-center gap-1 font-mono">
                                  <Star className="w-2.5 h-2.5 fill-[#F0D78C]" />
                                  {entry.badge}
                                </span>
                              )}
                            </div>
                        ...
                        <button
                          ...
                          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full border text-xs font-bold transition cursor-pointer ${
                            isLiked
                              ...
                              : 'bg-[#0F0C1A] border-[#D4AF37]/30 text-[#B3A6C9] hover:text-[#F0D78C] hover:border-[#D4AF37]'
                          }`}
                        >
                          <Heart className={`w-3.5 h-3.5 ${isLiked ? 'fill-[#F0D78C] text-[#F0D78C]' : ''}`} />
                          <span className="font-mono">{entry.likes}</span>
                        </button>
                      </div>

                      {/* Message Content */}
                      <p className="text-xs sm:text-sm text-[#F6EFE0] leading-relaxed pl-1 sm:pl-2 border-l-2 border-[#D4AF37] my-2 font-body">
                        "{entry.message}"
                      </p>

                      {/* Favorite Song Badge */}
                      {entry.favoriteSong && (
                        <div className="mt-3 pt-2 border-t border-[#D4AF37]/20 flex items-center gap-1.5 text-[11px] text-[#B3A6C9]">
                          <Music className="w-3 h-3 text-[#D4AF37]" />
                          <span>পছন্দের গান:</span>
                          <span className="text-[#F0D78C] font-medium italic">"{entry.favoriteSong}"</span>
                        </div>
                      )}
                    </div>
                  );
